    ...
    return(
      <div className={styles.tuInContainer}>
        ...
        <div className={styles.tuInContent}>
          The results from our first simulation seem promising. With twenty time windows (i.e. coupling time steps) using an explicit coupling scheme,
          we can already see the flap move. Increasing the number of time windows should allow us to
          see the flap oscillate. In this section of the tutorial, we will edit the preCICE configuration file to increase
          the number of time windows and see what results we get.
        </div>
      </div>
    );
  }
