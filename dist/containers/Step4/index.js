...
const exampleGraph = require("../../static/visualization.png");
    ...
    render() {
        return (React.createElement("div", { className: styles.subContainer },
            ...
            React.createElement("div", { className: styles.visialize },
                React.createElement("div", { className: styles.visialHeader },
                    "Visualization",
                    React.createElement("img", { src: exampleGraph, className: styles.graph })))));
    }
}
