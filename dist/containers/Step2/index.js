            ...
            React.createElement("div", { className: styles.expContainer },
                ...
                React.createElement("div", { id: "hideStep2", className: styles.expContent, hidden: this.props.hidCheck2 },
                    ...
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/tutorial/step2/sub1", className: styles.link }, TextForStep2.sub1)),
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/tutorial/step2/sub2", className: styles.link }, TextForStep2.sub2)),
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/tutorial/step2/sub3", className: styles.link }, TextForStep2.sub3)),
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/tutorial/step2/sub4", className: styles.link }, TextForStep2.sub4)),
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/tutorial/step2/sub5", className: styles.link }, TextForStep2.sub5)),
                    React.createElement("li", null,
                        React.createElement(react_router_dom_1.Link, { to: "/tutorial/step2/sub6", className: styles.link }, TextForStep2.sub6)))),
